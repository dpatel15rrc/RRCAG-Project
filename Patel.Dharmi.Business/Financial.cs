...
namespace Patel.Dharmi.Business
{
    ...
    public static class Financial
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException"> Thrown when the rate is less than 0, or when the rate is greater than 1, or when the number of payments is less than or equal to zero, or when the present value is less than or equal to zero. </exception>
